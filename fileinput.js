...
(function (factory) {
    ...
    tImage = '<div class="file-preview-frame{frameClass}" id="{previewId}"  data-fileindex="{fileindex}">\n' +
        ...
        '   {footer}\n' +
        '</div>\n';
    tText = '<div class="file-preview-frame{frameClass}" id="{previewId}"  title="{caption} "data-fileindex="{fileindex}">\n' +
        '   <pre class="file-preview-text" title="{caption}" ' + STYLE_SETTING + '>{data}</pre>\n' +
        '   {zoom}\n' +
        '   {footer}\n' +
        '</div>';
    tVideo = '<div class="file-preview-frame{frameClass}" id="{previewId}" title="{caption}" data-fileindex="{fileindex}"' +
        ...
        '   {footer}\n' +
        '</div>\n';
    tAudio = '<div class="file-preview-frame{frameClass}" id="{previewId}" title="{caption}" data-fileindex="{fileindex}"' +
        ' title="{caption}" ' + STYLE_SETTING + '>\n' +
        '   <audio controls>\n' +
        '       <source src="' + '{data}' + '" type="{type}">\n' +
        '       ' + DEFAULT_PREVIEW + '\n' +
    ...
    tFlash = '<div class="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}"' +
        ...
        '   {footer}\n' +
        '</div>\n';
    tObject = '<div class="file-preview-frame{frameClass}" id="{previewId}"  title="{caption}" data-fileindex="{fileindex}"' +
        ' title="{caption}" ' + STYLE_SETTING + '>\n' +
        '   <object class="file-object" data="{data}" type="{type}" width="{width}" height="{height}">\n' +
    ...
    FileInput.prototype = {
        ...
        clearFileInput: function () {
            ...
            function OnFail(result) {
                alert('Error al eliminar el arhivo.');
            ...
            self.getThumbs('.file-preview-success').each(function () {
                ...
                handler($remove, 'click', function () {
                    ...
                    if (typeof $thumb.attr('title') == "undefined") {
                        $("#" + $thumb.attr('id') + " img").each(function () {
                            archivo = $(this).attr('title');
                        });
                    }
                    else {
                        archivo = $thumb.attr('title');
                    }
